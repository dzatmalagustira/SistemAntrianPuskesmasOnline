    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div class="p-8">
                ...
                <h1 class="text-3xl font-bold text-center text-slate-900 dark:text-white mb-2">Daftar Akun</h1>
                <p class="text-center text-slate-600 dark:text-slate-400 mb-8">Buat akun untuk memulai booking</p>

                @if ($errors->any())
                    <div class="mb-6 p-4 bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg">
                        <ul class="text-sm text-red-800 dark:text-red-200 list-disc pl-5 space-y-1">
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="phone" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">No. Telepon</label>
                ...
                <div class="mt-6 text-center">
                    <p class="text-slate-600 dark:text-slate-400">Sudah punya akun? <a href="{{ route('login') }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">Masuk di sini</a></p>
                </div>
            </div>
        </div>
